        ...
        <v-col cols="12" xs="12" sm="12" md="12" lg="12" xl="12">
          <v-card>
            <v-tabs :vertical="windowSize.x <= 700 ? false : true">
              ...
              <v-tab>Privacy and Safety</v-tab>
              <v-tab>Email and Notifications</v-tab>
              <v-tab>Web Notifications</v-tab>
              <v-tab>Widgets</v-tab>
              <v-tab>Your Data</v-tab>
                  ...
                  <v-card-text class="py-0">
                    <v-list>
                      <v-list-item two-line>
                        ...
                        <v-list-item-action>
                          <v-switch v-model="dark" @change="darkmode"></v-switch>
                        </v-list-item-action>
                      </v-list-item>
                    </v-list>
                  </v-card-text>
                    ...
                    <v-list>
                      <v-list-item two-line>
                        <v-list-item-content class="pt-0">
                          ...
                          <v-list-item-subtitle>What is your favourite color?</v-list-item-subtitle>
                        </v-list-item-content>
                        <v-list-item-action>
                          <div>
                            <v-text-field solo dense rounded v-model="color" style="width:180px;">
                              <template v-slot:prepend-inner>
                                <v-avatar class="mr-2" size="30" :color="color"></v-avatar>
                              </template>
                            </v-text-field>
                          </div>
                        </v-list-item-action>
                    ...
                    <v-list>
                      <v-list-item two-line>
                        <v-list-item-content class="pt-0">
                          ...
                          <v-list-item-subtitle>What is your language preference?</v-list-item-subtitle>
                        </v-list-item-content>
                        <v-list-item-action>
                          <div>
                  ...
                  <v-card-text>
                    <v-row>
                      <v-col cols="12" xs="12" sm="12" md="8" lg="8" xl="8" class="py-0">
                        ...
                        <v-textarea label="Biography" outlined dense></v-textarea>
                        <v-btn color="primary">Save changes</v-btn>
                      </v-col>
                      <v-col cols="12" xs="12" sm="12" md="4" lg="4" xl="4">
                        <v-flex class="d-flex justify-center" style="width:100%;">
                          <v-avatar size="120">
                            <v-img src="https://appstack.bootlab.io/img/avatars/avatar.jpg"></v-img>
                          </v-avatar>
                        </v-flex>
                        <br />
                        <v-btn class="d-flex mx-auto" color="primary" small>
                          <v-icon class="mr-3">cloud_upload</v-icon>Upload
                        </v-btn>
                        <p class="mt-2 body-2 text-center">
                          For best results, use an image at
                          least
                          128px by 128px in .jpg format
                        </p>
                      </v-col>
                    </v-row>
                  </v-card-text>
                ...
                <v-card flat>
                  ...
                  <v-card-text>
                    <v-row>
                      ...
                      <v-col cols="12" class="py-0">
                        <v-text-field label="Address 2" outlined dense></v-text-field>
                      </v-col>
                      <v-col cols="6" class="py-0">
                        <v-text-field label="City" outlined dense></v-text-field>
                      </v-col>
                      <v-col cols="3" class="py-0">
                        <v-select :items="items" label="Choose" outlined dense></v-select>
                      </v-col>
                      <v-col cols="3" class="py-0">
                        <v-text-field label="Zip Code" outlined dense></v-text-field>
                      </v-col>
                    </v-row>
                    <v-btn color="primary">Save Changes</v-btn>
                  </v-card-text>
                ...
                <v-card flat>
                  ...
                  <v-card-text>
                    <v-row>
                      ...
                      <v-col cols="12" class="py-0">
                        <v-text-field label="Verify Password" outlined dense></v-text-field>
                      </v-col>
                    </v-row>
                    <v-btn color="primary">Save Changes</v-btn>
                  </v-card-text>
