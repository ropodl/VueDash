            ...
            <v-row>
                ...
                <v-col cols="12" xs="12" sm="12" md="8" lg="8" xl="8">
                    <v-card>
                        ...
                        <v-divider></v-divider>
                        <v-card-text>
                            <canvas id="totalrevenue" style="height:200px;"></canvas>
                        </v-card-text>
                    </v-card>
                </v-col>
                    ...
                    <v-card>
                        ...
                        <v-data-table :headers="header" :items="project">
                            <template v-slot:item.status="{ item }">
                                ...
                                <v-chip v-if="item.status == 'In Progress'" color="warning" small>{{ item.status }}
                                </v-chip>
                            </template>
                        </v-data-table>
                    </v-card>
                    ...
                    <v-card>
                        <v-card-title class="d-flex justify-space-between">
                            ...
                            <v-menu offset-y>
                                ...
                                <v-list dense>
                                    <v-list-item v-for="(item, index) in items" :key="index">
                                        <v-list-item-title link router :to="item.route">{{ item.title }}
                                        </v-list-item-title>
                                    </v-list-item>
                                </v-list>
                            </v-menu>
