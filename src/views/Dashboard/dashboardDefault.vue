      ...
      <v-row>
        <v-col cols="12" xs="12" sm="12" md="7" lg="7" xl="7">
          <v-card class="mb-5">
            ...
            <v-divider></v-divider>
            <v-card-text>
              <chartjs :id="revenuedata.id" :type="revenuedata.type" :data="revenuedata.data" :options="revenuedata.option" />
            </v-card-text>
          </v-card>
          <v-card class="mb-5">
            <v-card-title class="d-flex justify-space-between">
          ...
          <v-card>
            ...
            <v-divider></v-divider>
            <v-card-text>
              <chartjs :id="salesrevenuedata.id" :type="salesrevenuedata.type" :data="salesrevenuedata.data" :options="salesrevenuedata.option" />
            </v-card-text>
          </v-card>
        </v-col>
        <v-col cols="12" xs="12" sm="12" md="5" lg="5" xl="5">
          ...
          <v-card class="mb-5">
            ...
            <v-card-text style="height: 100%">
              <chartjs :id="'weeklysales'" :type="'doughnut'" :data="weeklysalesdata.data" :options="weeklysalesdata.option" height="200px" />
            </v-card-text>
          </v-card>
          <v-card>
            <v-card-title class="d-flex justify-space-between">
            ...
            datasets: [
              {
                label: "Sales ($)",
                fill: true,
                backgroundColor: ["blue", "indigo", "red", "cyan", "green", "orange", "red darken-1"],
